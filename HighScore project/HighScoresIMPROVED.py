...
while True: # loop the system
    ...
    if inp == "1":
        searchname = input("\nEnter user's name to search for: ").upper()
        ...
        name = input("Enter user's name: ").upper()
        if name in data:
            print("\n")
            ...
            while True:
                if highScore.isnumeric():
                    ...
                    highScore = input("\nEnter ONLY NUMBERS for the user's high score: ")
        ...
        searchname = input("\nEnter user's name to delete: ").upper()
        ...
        searchname = input("\nEnter user's name to update high score: ").upper()
        ...
        if searchname in data:
            ...
            while True:
                if highScore.isnumeric():
                    ...
                    highScore = input("\nEnter ONLY NUMBERS for the user's new high score: ")
